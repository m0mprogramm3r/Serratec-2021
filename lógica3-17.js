...
let garrafa = ler("Diga-me: quantos ml tem a garrafa? ");
let alcool = garrafa * 70 / 100
let gel = garrafa - alcool

console.log("Para se fazer álcool em gel em uma garrafa de " + garrafa + "ml, é necessário " + alcool + "ml de álcool, e de " + gel + "ml de gel!");